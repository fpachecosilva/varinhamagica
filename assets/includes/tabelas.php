        ...
        echo'
            <div class="local '.$local->sigla.' '.$local->ativo.'">
                ...
                <div class="modelo-3">
                  <table>
                    <tr>
                        ...
                        <td class="cel-amarela">Todos os dias e horários</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">Promocional Pré Venda</td>
                    </tr>
                    <tr>
                        <td colspan="2">Couvert Artístico + Água ou Refri + Entrada (surpresa)</td>
                    </tr>
                    <tr>
                        <td>R$ 45,00</td>
                        <td>R$ 35,00</td>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">Combo VIP</td>
                    </tr>
                    <tr>
                        <td colspan="2">Show, Entrada e Prato Principal</td>
                    </tr>
                    <tr>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">Promocional Pré Venda Show + Café da Manhã</td>
                    </tr>
                    <tr>
                        <td>R$ 79,90</td>
                        <td>R$ 69,90</td>
